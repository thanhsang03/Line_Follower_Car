#define RightDirectPin1  7    
#define RightDirectPin2  6    
#define speedPinL 10     
#define LeftDirectPin1  4    
#define LeftDirectPin2  5   
#define speedPinR 11     
...
int watch(){
  ...
  echo_distance1=echo_distance1*0.01657;
  digitalWrite(Trig_PIN,LOW);
  delayMicroseconds(2);                                                                              
  digitalWrite(Trig_PIN,HIGH);
  delayMicroseconds(10);
  ...
  echo_distance2=echo_distance2*0.01657; 
